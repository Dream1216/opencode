...
export function update(adapter: Adapter, event: SessionEvent.Event) {
  ...
  return Effect.gen(function* () {
    yield* SessionEvent.All.match(event, {
      ...
      "session.next.model.invocation.attempted": () => Effect.void,
      "session.next.model.invocation.retried": () => Effect.void,
      "session.next.model.invocation.usage": () => Effect.void,
      "session.next.model.invocation.completed": () => Effect.void,
      "session.next.model.invocation.failed": () => Effect.void,
      "session.next.worker.scheduled": () => Effect.void,
      "session.next.worker.resumed": () => Effect.void,
      "session.next.worker.started": () => Effect.void,
      "session.next.worker.stop_requested": () => Effect.void,
      "session.next.worker.stopped": () => Effect.void,
      "session.next.worker.completed": () => Effect.void,
      "session.next.worker.failed": () => Effect.void,
      "session.next.worker.lease": () => Effect.void,
      "session.next.workflow.bound": () => Effect.void,
      "session.next.tenant.bound": () => Effect.void,
      "session.next.rls.evaluated": () => Effect.void,
      "session.next.audit.recorded": () => Effect.void,
      "session.next.release.governance.evaluated": () => Effect.void,
